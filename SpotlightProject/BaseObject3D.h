...
protected:
	virtual void buildObjectBuffers( IDirect3DDevice9* gd3dDevice );
...
public:
	...
	virtual void Create( IDirect3DDevice9* gd3dDevice ) final { buildObjectBuffers(gd3dDevice); UpdateStatistics();	};
